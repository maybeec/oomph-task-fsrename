...
public class fsrenamePackageImpl extends EPackageImpl implements fsrenamePackage
{
  ...
  {
		if (isInited) return (fsrenamePackage)EPackage.Registry.INSTANCE.getEPackage(fsrenamePackage.eNS_URI);

		// Obtain or create and register package
		fsrenamePackageImpl thefsrenamePackage = (fsrenamePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof fsrenamePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new fsrenamePackageImpl());
  ...
  public void initializePackageContents()
  {
		...
		initEAttribute(getFSRenameTask_Resource(), ecorePackage.getEString(), "resource", null, 1, 1, FSRenameTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFSRenameTask_Destination(), ecorePackage.getEString(), "destination", null, 1, 1, FSRenameTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
